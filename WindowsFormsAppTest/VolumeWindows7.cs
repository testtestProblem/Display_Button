...
namespace Win8Hottab
{
    class VolumeWindows7
    {
        ...
        /// Constructor
        /// </summary>
        public VolumeWindows7()
        {
            const uint CLSCTX_INPROC_SERVER = 1;
            Guid clsid = new Guid("BCDE0395-E52F-467C-8E3D-C4579291692E");
            Guid IID_IUnknown = new Guid("00000000-0000-0000-C000-000000000046");
            //Guid clsid = new Guid("A95664D2-9614-4F35-A746-DE8DB63617E6");
            //Guid IID_IUnknown = new Guid("A95664D2-9614-4F35-A746-DE8DB63617E6");
            oEnumerator = null;
        ...
        public int Mute
        {
            ...
            set
            {
                ...
                int mute = value;
                // TODO
                // P[roblem #2 : This function always terminate with an internal error!
        ...
        public float MasterVolume
        {
            ...
            set
            {
                float level = (float)value/(float)100.0;
                Guid nullGuid;
                //nullGuid = new Guid("{00000000-0000-0000-0000-000000000000}"); // null
                // {dddddddd-dddd-dddd-dddd-dddddddddddd}
                nullGuid = Guid.Empty;
        ...
        /*
public static bool GetSystemMute()
{
bool mute = false;
object oEnumerator = null;
IMMDeviceEnumerator iMde = null;
